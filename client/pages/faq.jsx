      ...
      <section>
        ...
        <div className="row">
          <div className="col-md-6 col-lg-4 mb-4">
            <h6 className="mb-3 text-dark"><i className="far fa-paper-plane text-muted pe-2" /> Do I need a wedding planner?</h6>
            <p>
          ...
          <div className="col-md-6 col-lg-4 mb-4">
            <h6 className="mb-3 text-dark"><i className="fas fa-pen-alt text-muted pe-2" /> What Does A Venue Coordinator Do?</h6>
            <p>
          ...
          <div className="col-md-6 col-lg-4 mb-4">
            <h6 className="mb-3 text-dark"><i className="fas fa-user text-muted pe-2" /> How much does a wedding planner cost?
            </h6>
            <p>
          ...
          <div className="col-md-6 col-lg-4 mb-4">
            <h6 className="mb-3 text-dark"><i className="fas fa-rocket text-muted pe-2" /> Do you have to pay a wedding coordinator?
            </h6>
            <p>
          ...
          <div className="col-md-6 col-lg-4 mb-4">
            <h6 className="mb-3 text-dark"><i className="fas fa-home text-muted pe-2" /> What Does A Wedding Stylist Do?
            </h6>
          ...
          <div className="col-md-6 col-lg-4 mb-4">
            <h6 className="mb-3 text-dark"><i className="fas fa-book-open text-muted pe-2" /> What Does A Wedding Planner Do?
            </h6>
            <p>
