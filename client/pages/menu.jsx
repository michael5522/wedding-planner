            ...
            <div className="row justify-content-center">
              ...
              <div className="col-md-4 d-flex">
                <a href="#faq" className="card mb-4 box-shadow border rounded">
                  ...
                  <div className="card-body padding-0-for-card-body">
                    <h5 className="card-title mb-2 text-center"><i className="far fa-map text-muted pe-2 mr-2" />FAQ</h5>
              ...
              <div className="col-md-4 d-flex">
                <a href="#guestlist" className="card mb-4 box-shadow border rounded">
                  <img className="card-img-top img-fluid" src="/images/happy.jpeg" alt="Card image cap"/>
                  <div className="card-body padding-0-for-card-body">
                    <h5 className="card-title mb-2 text-center"><i className="fas fa-phone text-muted pe-2 mr-2" />Guest List Manager</h5>
              ...
              <div className="col-md-4 d-flex">
                <a href="#weddingchecklist" className="card mb-4 box-shadow border rounded">
                  <img className="card-img-top img-fluid" src="/images/happy.jpeg" alt="Card image cap" />
                  <div className="card-body padding-0-for-card-body">
                    <h5 className="card-title mb-2 text-center"><i className="fas fa-route text-muted pe-2 mr-2" />Wedding Timeline</h5>
              ...
              <div className="col-md-4 d-flex">
                <a href="#budgetlist" className="card mb-4 box-shadow border rounded">
                  <img className="card-img-top img-fluid" src="/images/happy.jpeg" alt="Card image cap" />
                  <div className="card-body padding-0-for-card-body">
                    <h5 className="card-title mb-2 text-center"><i className="fas fa-balance-scale-left text-muted pe-2 mr-2" />Budgeter</h5>
              ...
              <div className="col-md-4 d-flex">
                <a href="#cateringlist" className="card mb-4 box-shadow border rounded">
                  <img className="card-img-top img-fluid" src="/images/happy.jpeg" alt="Card image cap" />
                  <div className="card-body padding-0-for-card-body">
                    <h5 className="card-title mb-2 text-center"><i className="fas fa-utensils text-muted pe-2 mr-2" />Catering List</h5>
